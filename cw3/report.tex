...
\begin{figure}[h]
  \centering
  \subfloat[Weights]{\label{stddev-w}\includegraphics[width=\smallgraphwidth]{results/linear-coev.png}}
  \qquad
  \subfloat[Exponents]{\label{stddev-e}\includegraphics[width=\smallgraphwidth]{results/linear-coev-vs-no-coev.png}}
